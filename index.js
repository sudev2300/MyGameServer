...
const UserSchema = new mongoose.Schema(
  {
    ...
    balance: { type: Number, default: 0 }, // الكوينزات (عملة اللعب)
    diamonds: { type: Number, default: 0 }, // الماس (عملة الهدايا)
  },
  { timestamps: true }
);
...
const TransactionSchema = new mongoose.Schema(
  {
    userId: String,
    type: String, // bet, win, loss, topup, payout, house_credit, house_debit, adjust, gift_sent, gift_received
    amount: Number,
    game: String,
    meta: Object,
...
const WinnerSchema = new mongoose.Schema(
  {
    roundId: String,
    name: String, // userId أو اسم معروض
    userId: String,
    prize: Number,
    label: String, // مثلاً "Roulette 13 red x2"
    game: String,
    date: { type: Date, default: Date.now },
  },
  { timestamps: true }
...
const DailyScoreSchema = new mongoose.Schema(
  {
    ...
    score: { type: Number, default: 0 }, // أرباح - خسائر خلال اليوم
  },
  { timestamps: true }
);
...
const BetSchema = new mongoose.Schema(
  {
    roundId: String,
    userId: String,
    optionId: String, // roulette: 0,1_12,red...
    amount: Number,
...
const RocketStateSchema = new mongoose.Schema(
  {
    _id: String, // سيكون دائما "rocket_state"
